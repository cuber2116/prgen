...
class GeminiClient:
    ...
    def generate(self, *, diff: str, status: str, recent_log: str) -> tuple[str, str]:
        ...
        prompt = (
            ...
            "...\n"
            "</PR_NOTES>\n\n"
            "CRITICAL: Focus ONLY on the specific changes shown in the DIFF below. "
            "Do NOT describe the overall feature or project. "
            "Describe what was added, modified, or removed in THIS commit.\n\n"
            "Rules for COMMIT_MESSAGE:\n"
            "- First line: concise imperative title <= 72 chars describing the specific change\n"
            "- Blank line after title\n"
            "- Body: wrap at ~100 chars, explain WHAT changed in this diff and WHY\n"
            "- Be specific about files, functions, or schema fields that were modified\n"
            "- Mention specific implementation details visible in the diff\n"
            "- Include Testing section if test changes are visible in the diff\n"
            "Rules for PR_NOTES:\n"
            "- Markdown\n"
            "- Include: Summary (of THIS commit's changes), Notable changes (specific to this diff), "
            "Testing (if visible in diff), Risk/rollback, Follow-ups\n"
            "- Focus on what THIS commit does, not the overall feature\n\n"
            "Context:\n"
